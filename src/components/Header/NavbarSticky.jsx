...
const NavbarSticky = () => {
    ...
    return isUserFetching ? (
        ...
        >
            <Navbar
                variant="gradient"
                className="mx-auto shadow-none border-none bg-white text-primary-500 w-full px-4 py-2 lg:px-6"
            >
                <div className="flex items-center justify-between md:gap-14">
                    ...
                    >
                        <MenuHandler>
                            ...
                            >
                                <span className="navbar-item hover:text-primary-500 text-primary-500 font-bold">
                                    Brands
                                </span>
                            </Typography>
                        </MenuHandler>
                    ...
                    >
                        <Link
                            to="/products"
                            className="navbar-item  font-bold hover:text-primary-500  text-primary-500"
                        >
                            Products
                        </Link>
                    </Typography>
                        ...
                        {user && userData?.doc ? (
                            ...
                            <Menu>
                                <MenuHandler>
                                    ...
                                    <button className="btn bg-primary-500 rounded-full text-white">
                                        Sign in / Join
                                    </button>
                                </MenuHandler>
                                <MenuList className="shadow-md">
